...
export function showMediaTitle(mediaTitle) {
  document.querySelector('div#content-ui--title').innerHTML = mediaTitle
}

export function showMediaEpisodes(mediaEpisodes) {
  document.querySelector('#content-ui--total-episodes').innerHTML = mediaEpisodes
}
...
export function showUserProgress(episodeNumber) {
  document.querySelector('#content-ui--episode-progress').innerHTML = episodeNumber
}
